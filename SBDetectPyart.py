...
def grid_from_polar_to_rectilinear(my_ref,lons,lats,nlon,nlat):
    rav_lats = lats.ravel()
    rav_lons = lons.ravel()
...
###########################################################################
    ...
    gref, glon, glat = grid_from_polar_to_rectilinear(my_ref,lons,lats,nlon,nlat)
...
###########################################################################
    ...
    sbfailure, sbf = sea_breeze_front_coords(gref,glon,glat)
